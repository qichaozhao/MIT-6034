...
#
# You can modify the existing alpha_beta_negamax interface in lab3
...
def TEST_1(expected):
    from lab3 import alpha_beta_negamax
...
if __name__ == "__main__":
    ...
    # from basicplayer import minimax_find_board_value

    TEST_1("I")
    # print alpha_beta_board_search.get_count()
    # print minimax_find_board_value.get_count()
