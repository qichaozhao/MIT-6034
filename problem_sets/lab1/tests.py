...
make_test(type='VALUE',
          ...
          expected_val="[ 'rock beats rock', 'rock beats scissors', 'rock beats paper', 'scissors beats rock', 'scissors beats scissors', 'scissors beats paper', 'paper beats rock', "
                       "'paper beats scissors', 'paper beats paper' ]",
